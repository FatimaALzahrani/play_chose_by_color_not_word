...
class _QuizScreenState extends State<QuizScreen> {
  ...
  @override
  void initState() {
    //داله تمثل اول حاله بياخذه الاستست فل ودجت
    colors
        .shuffle(); //عشان يغير ترتيب مصفوفه المدن ويصير كل مره مدن عشوائيه تطلع
    color.shuffle();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    //   col=Colors.white as MaterialColor;
      ...
      col = Colors.pink;
    else if (color[num] == "بنفسجي") col = Colors.purple;
                          ...
                          onPressed: () {
                            ...
                            if (color[num] == colo[i]) {
                              Fluttertoast.showToast(
                                msg: "إجابة صحيحه , أحسنت",
                                backgroundColor: Colors.green,
                              );
                              yes++;
                            } else {
                              Fluttertoast.showToast(
                                msg: "إجابة خاطئه , حاول مره أخرى",
